...
```javascript
constants = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-uint16@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-uint16@umd/bundle.js"></script>
```
